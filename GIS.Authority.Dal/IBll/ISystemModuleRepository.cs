...
{
    public interface ISystemModuleRepository : IBasicRepository<SystemModule>
    {
        List<GIS.Authority.Entity.System> GetSystemModule(PredicateGroup group, PageQuery query);
